...
def get_app_dir(app_name: str, roaming: bool = True, force_posix: bool = False) -> str:
    ...
    :param force_posix: if this is set to `True` then on any POSIX system the
                        folder will be stored in the dashboard_extension folder with a leading
                        dot instead of the XDG config dashboard_extension or darwin's
...
def _expand_args(
    ...
    *,
    ...
    :param user: Expand user dashboard_extension directory.
